 ...
 */
public class store_manager_inventory extends javax.swing.JFrame {

    /**
     * Creates new form store_manager_dashboard
     */
    public store_manager_inventory() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        dashboard_button_panel.setBackground(new java.awt.Color(65, 67, 106));
        ...
        dashboard_label.setForeground(new java.awt.Color(254, 150, 103));
        ...
        inventory_button_panel.setBackground(new java.awt.Color(254, 150, 103));
        inventory_button_panel.setPreferredSize(new java.awt.Dimension(100, 50));

        inventory_label.setBackground(new java.awt.Color(255, 255, 255));
...
//            java.util.logging.Logger.getLogger(store_manager_inventory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new store_manager_inventory().setVisible(true);
//            }
//        });
//    }

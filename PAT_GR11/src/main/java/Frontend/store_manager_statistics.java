 ...
 */
public class store_manager_statistics extends javax.swing.JFrame {

    /**
     * Creates new form store_manager_dashboard
     */
    public store_manager_statistics() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        statistics_button_panel.setBackground(new java.awt.Color(254, 150, 103));
...
//            java.util.logging.Logger.getLogger(store_manager_statistics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new store_manager_statistics().setVisible(true);
//            }
//        });
//    }
